				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index.jsp?type=console">Consoles</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="userHome.jsp?type=console">Consoles</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="adminViewProduct.jsp?type=console">Consoles</a></li>
						</ul></li>
